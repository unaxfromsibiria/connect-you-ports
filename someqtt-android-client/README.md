# SoMeQTT Android Client

This project implements a lightweight client for Android devices to interact with the **someqtt** server application (for forwarding TCP and UDP traffic).
